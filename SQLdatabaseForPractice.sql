...
select number from student_phone where studentID = 5;

select * from student_address where studentid = 10;

select * from faculty;

select fp.number from faculty_phone fp inner join faculty f on fp.facultyID = f.ID and f.ID = 2; 

select * from student_phone where studentid = 13;
...
select m.* from course_modules cm inner join modules m on cm.moduleID = m.ID where cm.courseID=1;

select * from course_batches where capacity=80;

select * from student;

select namefirst, namelast from student order by namefirst asc;

select TOP 5 namefirst, namelast, dob, emailid from student ;

select TOP 5 namefirst, namelast, dob, emailid from student order by Id desc;

select * from student where ID in (1,2,5,7);

select top 7 ID, namefirst , namelast,emailid from student where ID not in (5,10,15);

select top 2 * from faculty;

select * from student_phone order by number asc;

select * from student_address where studentID in (2,4,6,10) order by studentid desc;

select * from modules order by name asc;

select top 10 * from modules order by name desc;
...
select * from student_qualifications where college = 'new york';
 ...
 select * from faculty_qualifications where facultyID in (1,3);

 select * from student_qualifications where year = 2018;
 ...
 select lower(namefirst), LOWER(namelast) from student;

 select namefirst, namelast, emailid from student where len(emailID) = 21;

 select namefirst, namelast, SUBSTRING(namefirst,1,3) str from student;

 select namefirst, namelast , SUBSTRING(namefirst,LEN(namefirst)-2,3) str from student;

 select * from student_phone where SUBSTRING(number,1,2) ='70';


 Select * from student where namefirst like '%su%';

 select * from student_phone where number like '70%';
